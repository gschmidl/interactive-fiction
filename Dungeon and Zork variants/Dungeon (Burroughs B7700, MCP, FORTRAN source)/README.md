...
**Status: PORTED 2026-09-22.** `port\run.bat` runs `port\dungeon.exe`, the game compiled from its own B7700 FORTRAN
...
- `archive_original\CSL-1000_Rev-2213.zip` - the INTEREX CSL/1000 library release 2213 (TF tape image; also in
  `..\..\_work\_HP1000_work\CSL-1000\`, from `bitsavers.org/bits/HP/HP_1000_software_collection/specials/`). Contribution A072, "Dungeons
