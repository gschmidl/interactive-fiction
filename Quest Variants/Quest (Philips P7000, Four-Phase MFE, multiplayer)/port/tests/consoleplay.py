...
screen model (common.Screen).
  ...
  3. Two windows: a game for two, and a second window started the same way joins it as
     ...
     in the first.
  4. run.bat, from a copy of the port in a scratch folder, plays.
"""
import ctypes
