...
/* ZORK.PR and FERRET.PR end their shared half exactly at word 0x80000, but
 * QUEST.PR and QUEST_SERVER.PR are linked to a top of 1536 blocks = word
 * 0x180000, and the shared partition they build sits above that again, so
 * the ring image here is two megawords.  MADDR masks, so this has to stay a
 * power of two. */
#define MEMWORDS   0x200000u       /* 2M words                             */
