...
static const Game games[] = {
    ...
    { "svha", "SVHA Adventure", "SVHA-ADVENTURE.PROG", CS_ASCII, SAVE_SNAPSHOT, 0, 0,
      0116334, 0116350, 017047, 013011, 0116430, 0, NULL },
    { "mordor", "Mordor", "MORDOR-MJ.PROG", CS_SWEDISH, SAVE_NONE, 0, 0,
      0, 0, 0, 0, 0, 1, "MORDOR-MAP-MJ.DATA" },
};
...
static void usage(FILE *o)
{
    ...
    if (game->nd_pascal)
        fprintf(o,
            ...
            "      --no-rubout      no rubbing out while typing, as on SINTRAN III\n");
    fprintf(o,
...
int main(int argc, char **argv)
{
    ...
    int unlimited = 0, new_map = 0, no_rubout = 0;
    uint16_t start = 0;
    ...
    for (i = 1; i < argc; i++) {
        ...
        else if ((!strcmp(a, "-u") || !strcmp(a, "--unlimited")) && game->nd_pascal) unlimited = 1;
