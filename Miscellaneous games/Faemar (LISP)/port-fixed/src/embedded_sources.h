/* Auto-generated embedded Lisp source for Faemar -- FIXED build.
   game_clean.txt (engine) is byte-identical to the faithful port's copy.
   faemar_fixed.txt (world data) differs from faemar_clean.txt in exactly
   two places: HAND's 'move X on hand' handler, and EYES gaining a 'take'
   win-condition handler. See faemar_fixed.txt for both diffs inline. */
