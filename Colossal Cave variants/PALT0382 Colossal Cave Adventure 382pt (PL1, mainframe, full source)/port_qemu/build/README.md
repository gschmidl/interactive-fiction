...
Double-click **`run.bat`**, or run it from a terminal. Say `NO` to
...
your actual disk and are still there next time you launch `run.bat`
...
- `run.bat` — the launcher. Just calls `qemu-system-x86_64.exe`
