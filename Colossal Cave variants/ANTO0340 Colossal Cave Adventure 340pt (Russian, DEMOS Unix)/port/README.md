...
**To play: run `run.bat`** (or `adventure.exe`). Type in Russian:
...
| `run.bat` / `play-revised-text.bat` | pick a wording and run |
...
* `run.bat` — the 1985 text as the zip has it, typos and all
