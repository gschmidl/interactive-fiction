...
void itverb()
{
	...
	/* PORT: Fix 3 - bug(29) ended the game on LEAVE ALL, LEAVE
	   EVERYTHING, DROP LEAVE ...; with the fixes it asks "leave what?" */
    case LEAVE:		if (port_fixes) needobj(); else bug(29);	break;
