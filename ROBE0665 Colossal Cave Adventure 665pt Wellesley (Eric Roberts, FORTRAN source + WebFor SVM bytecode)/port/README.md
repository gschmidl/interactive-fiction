...
|---|---|---|
| `play.bat` | `newadv.exe` - Roberts' FORTRAN source (`..\src_original\ROBE0665`, newadv.F last modified 3 March 2010) compiled with gfortran | `-- ADVENTURE (V6.2),  3-Mar-10 --`, "a possible 655" |
