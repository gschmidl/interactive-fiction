...
static const Game games[] = {
    ...
    { "svha", "SVHA Adventure", "SVHA-ADVENTURE.PROG", CS_ASCII, SAVE_SNAPSHOT, 0, 0,
      0116334, 0116350, 017047, 013011, 0116430, 0, 0, NULL },
    { "mordor", "Mordor", "MORDOR-MJ.PROG", CS_SWEDISH, SAVE_NONE, 0, 0,
      0, 0, 0, 0, 0, 1, 0, "MORDOR-MAP-MJ.DATA" },
    { "legend", "Legend", "LEGEND-LU.PROG", CS_SWEDISH, SAVE_NONE, 0, 0,
      0, 0, 0, 0, 0, 0, 1, NULL },
};
