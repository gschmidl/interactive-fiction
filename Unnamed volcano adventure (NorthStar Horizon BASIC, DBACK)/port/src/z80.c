...
/* AND, XOR and OR clear the carry (and N; AND sets H, the others clear it).
   set_sz53p keeps the old carry, which is right for IN r,(C), RLD and RRD
   but not here: "ORA A" to clear the carry is everywhere in 8080 code. */
