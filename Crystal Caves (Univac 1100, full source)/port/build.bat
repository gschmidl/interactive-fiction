...
"%GFORTRAN%" -std=legacy -ffixed-form -ffixed-line-length-none -fno-range-check -O2 -I. ^
  -o ..\build\cave.exe ^
  main.f darkrm.f upperc.f bug.f ciao.f datime.f getcls.f getin.f hours.f motd.f move.f ^
...
copy /y "%~dp0..\DATA.TXT" "%~dp0build\CAVE.DAT" >nul
echo Build OK: build\cave.exe (with build\CAVE.DAT alongside it)
