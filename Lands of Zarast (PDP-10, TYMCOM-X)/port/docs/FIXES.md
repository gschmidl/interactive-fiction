...
| a dropped mace attacks | Its hit-point value in the DATA is 55, where every other object has 1, and anything with 2 or more counts as a monster | Line 1740, after the DATA is read, sets it to 1 |
