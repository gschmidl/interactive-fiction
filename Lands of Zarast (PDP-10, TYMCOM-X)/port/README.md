...
its last victim back or stays in your hands. Treasures dropped in the store are sold for gold, the merchant sells weapons back at twice the price and takes unused goods back at half, monsters no longer hit for negative damage, a thrown weapon can hit the stirge, the axe gets its bonus, critical hits can be a "good hit", the titan gets the hit points the mace took, the mace
