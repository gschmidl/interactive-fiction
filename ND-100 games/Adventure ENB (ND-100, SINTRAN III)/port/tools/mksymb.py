"""basic\ADVENTURE-ENB.txt -> basic\ADVENTURE-ENB.SYMB, the form SINTRAN
...
TXT = os.path.join(PORT, 'basic', 'ADVENTURE-ENB.txt')
SYMB = os.path.join(PORT, 'basic', 'ADVENTURE-ENB.SYMB')
