...
C     PANIC says whether he-6841733142 s trapped in the cave
...
1005  FORMAT(1I8,A72)
      ...
      DO 1006 K=1,18
      KK=LINUSE+19-K
      IF((LINES(KK).XOR.17315143744 ).NE.0)GOTO 1007
1006  CONTINUE
...
C  AREA BETWEEN 1004 AND HERE).
      DO 1009 J=ERA2,ERA3
1009  LINES(J)=LINES(J).XOR.34143154240 
...
C  CORE-IMAGE HARDER.  NOTE THAT 25465106544  HAD BETTER NOT BE IN THE LIST, SINCE
...
1042  ATAB(TABNDX)=ATAB(TABNDX).XOR.-25465106624 
      CALL BUG(4)
C
...
C
C  IF SETUP=2 WE DON-23485528694 S ONLY NECESSARY IF WE HAVEN'T DONE
...
C
C      KEYS=VOCAB(CODE(-28161813696 ),1)
C      LAMP=VOCAB(CODE(-27642113984 ),1)
C      GRATE=VOCAB(CODE(-30255557568 ,-31540109248 ),1)
C      CAGE=VOCAB(CODE(-32474151616 ),1)
C      ROD=VOCAB(CODE(-24362475456 ),1)
C      ROD2=ROD+1
C      STEPS=VOCAB(CODE(-23804587968 ,-24023916480 ),1)
C      BIRD=VOCAB(CODE(-32977107904 ),1)
C      DOOR=VOCAB(CODE(-31878294976 ),1)
C      PILLOW=VOCAB(CODE(-25461109696 ,-26171400128 ),1)
C      SNAKE=VOCAB(CODE(-23829886144 ,-31540109248 ),1)
C      FISSUR=VOCAB(CODE(-30829587648 ,-22950174656 ),1)
C      TABLET=VOCAB(CODE(-23347508160 ,-31540109248 ),1)
C      CLAM=VOCAB(CODE(-32428208832 ),1)
C      OYSTER=VOCAB(CODE(-25930640320 ,-31540109248 ),1)
C      MAGZIN=VOCAB(CODE(-27105443520 ,-20265820096 ),1)
C      DWARF=VOCAB(CODE(-31845199296 ,-31003238336 ),1)
C      KNIFE=VOCAB(CODE(-28124592576 ,-31540109248 ),1)
C      FOOD=VOCAB(CODE(-30804556736 ),1)
C      BOTTLE=VOCAB(CODE(-32951872448 ,-27782012864 ),1)
C      WATER=VOCAB(CODE(-21736307392 ,-24560787392 ),1)
C      OIL=VOCAB(CODE(-25997991872 ),1)
C      PLANT=VOCAB(CODE(-25448886720 ,-23487045568 ),1)
C      PLANT2=PLANT+1
C      AXE=VOCAB(CODE(-33451499456 ),1)
C      MIRROR=VOCAB(CODE(-27071524288 ,-26171400128 ),1)
C      DRAGON=VOCAB(CODE(-31866173632 ,-26171400128 ),1)
C      CHASM=VOCAB(CODE(-32444984512 ,-27245141952 ),1)
C      TROLL=VOCAB(CODE(-23275779008 ,-27782012864 ),1)
C      TROLL2=TROLL+1
C      BEAR=VOCAB(CODE(-32994438592 ),1)
C      MESSAG=VOCAB(CODE(-27088268480 ,-33687592896 ),1)
C      VEND=VOCAB(CODE(-22256597952 ,-29392625600 ),1)
C      BATTER=VOCAB(CODE(-33010592704 ,-31540109248 ),1)
C      STONE=VOCAB(CODE(-23804260800 ,-31540109248 ),1)
C      PLAQUE= VOCAB(CODE(-25448885952 ,-22950174656 ),1)
C      TPASS = VOCAB(CODE(-23284624576 ,-24023916480 ),1)
C      BROOM = VOCAB(CODE(-32939454656 ,-27245141952 ),1)
C      MAP   = VOCAB(CODE(-27105157056 ),1)
C      DAGGER= VOCAB(CODE(-31937280192 ,-31540109248 ),1)
C      ELVNDR= VOCAB(CODE(-31353780928 ,-26708271040 ),1)
C      TRAP  = VOCAB(CODE(-23276236736 ),1)
C      MAGICN= VOCAB(CODE(-27105441472 ,-32613851072 ),1)
C      SIGN  = VOCAB(CODE(-23850660288 ),1)
C      BOOK  = VOCAB(CODE(-32952038592 ),1)
C      STAFF = VOCAB(CODE(-23804721600 ,-31003238336 ),1)
CC
CC  OBJECTS FROM 50 THROUGH WHATEVER ARE TREASURES.  HERE ARE A FEW.
CC
C      NUGGET=VOCAB(CODE(-30267784128 ),1)
C      COINS=VOCAB(CODE(-32415363520 ,-24023916480 ),1)
C      CHEST=VOCAB(CODE(-32444853440 ,-23487045568 ),1)
C      EGGS=VOCAB(CODE(-31375240384 ),1)
C      TRIDNT=VOCAB(CODE(-23275977664 ,-31540109248 ),1)
C      VASE=VOCAB(CODE(-22273211072 ),1)
C      EMRALD=VOCAB(CODE(-31350140352 ,-33687592896 ),1)
C      PYRAM=VOCAB(CODE(-25393807040 ,-27245141952 ),1)
C      PEARL=VOCAB(CODE(-25478245824 ,-27782012864 ),1)
C      RUG=VOCAB(CODE(-24337211328 ),1)
C      CHAIN=VOCAB(CODE(-32444987072 ,-26708271040 ),1)
C      SPICES=VOCAB(CODE(-23821237440 ,-31540109248 ),1)
C      CROWN=VOCAB(CODE(-32402581696 ,-26708271040 ),1)
C      RING=VOCAB(CODE(-24387303616 ),1)
C      SWORD=VOCAB(CODE(-23791676864 ,-32076980160 ),1)
C      MITHRL= VOCAB(CODE(-27071461312 ,-24560787392 ),1)
C      SCHOL = VOCAB(CODE(-23875793088 ,-27782012864 ),1)
CC
CC  THESE ARE MOTION-VERB NUMBERS.
CC
C      BACK=VOCAB(CODE(-33011152064 ),0)
C      LOOK=VOCAB(CODE(-27583329472 ),0)
C      CAVE=VOCAB(CODE(-32473660096 ),0)
C      NULL=VOCAB(CODE(-26484519872 ),0)
C      ENTRNC=VOCAB(CODE(-31345454528 ,-33687592896 ),0)
C      DPRSSN=VOCAB(CODE(-31920205248 ,-31540109248 ),0)
CC
CC  AND SOME ACTION VERBS.
CC
C      SAY=VOCAB(CODE(-23883636672 ),2)
C      LOCK=VOCAB(CODE(-27583722688 ),2)
C      THROW=VOCAB(CODE(-23317622976 ,-21876432832 ),2)
C      FIND=VOCAB(CODE(-30829755328 ),2)
C      INVENT=VOCAB(CODE(-29197908672 ,-26708271040 ),2)
C      WEAR  = VOCAB(CODE(-21720149440 ),2)
C      REMOVE= VOCAB(CODE(-24404111552 ,-22413303744 ),2)
C
C THESE ARE THE ORIGINAL DEC-10 DEFINITIONS TO BE USED WHEN
C CODE IS NOT AVAILABLE
      KEYS=VOCAB(-28161813696 ,1)
      LAMP=VOCAB(-27642113984 ,1)
      GRATE=VOCAB(-30255557494 ,1)
      CAGE=VOCAB(-32474151616 ,1)
      ROD=VOCAB(-24362475456 ,1)
      ROD2=ROD+1
      STEPS=VOCAB(-23804587866 ,1)
      BIRD=VOCAB(-32977107904 ,1)
      DOOR=VOCAB(-31878294976 ,1)
      PILLOW=VOCAB(-25461109602 ,1)
      SNAKE=VOCAB(-23829886070 ,1)
      FISSUR=VOCAB(-30829587542 ,1)
      TABLET=VOCAB(-23347508086 ,1)
      CLAM=VOCAB(-32428208832 ,1)
      OYSTER=VOCAB(-25930640246 ,1)
      MAGZIN=VOCAB(-27105443404 ,1)
      DWARF=VOCAB(-31845199220 ,1)
      KNIFE=VOCAB(-28124592502 ,1)
      FOOD=VOCAB(-30804556736 ,1)
      BOTTLE=VOCAB(-32951872360 ,1)
      WATER=VOCAB(-21736307292 ,1)
      OIL=VOCAB(-25997991872 ,1)
      PLANT=VOCAB(-25448886616 ,1)
      PLANT2=PLANT+1
      AXE=VOCAB(-33451499456 ,1)
      MIRROR=VOCAB(-27071524194 ,1)
      DRAGON=VOCAB(-31866173538 ,1)
      CHASM=VOCAB(-32444984422 ,1)
      TROLL=VOCAB(-23275778920 ,1)
      TROLL2=TROLL+1
      BEAR=VOCAB(-32994438592 ,1)
      MESSAG=VOCAB(-27088268414 ,1)
      VEND=VOCAB(-22256597870 ,1)
      BATTER=VOCAB(-33010592630 ,1)
      STONE=VOCAB(-23804260726 ,1)
      PLAQUE=VOCAB(-25448885846 ,1)
      TPASS=VOCAB(-23284624474 ,1)
      BROOM=VOCAB(-32939454566 ,1)
      MAP=VOCAB(-27105157056 ,1)
      DAGGER=VOCAB(-31937280118 ,1)
      ELVNDR=VOCAB(-31353780836 ,1)
      TRAP=VOCAB(-23276236736 ,1)
      MAGICN=VOCAB(-27105441402 ,1)
      SIGN=VOCAB(-23850660288 ,1)
      BOOK=VOCAB(-32952038592 ,1)
      STAFF=VOCAB(-23804721524 ,1)
      NUGGET=VOCAB(-30267784128 ,1)
      COINS=VOCAB(-32415363418 ,1)
      CHEST=VOCAB(-32444853336 ,1)
      EGGS=VOCAB(-31375240384 ,1)
      TRIDNT=VOCAB(-23275977590 ,1)
      VASE=VOCAB(-22273211072 ,1)
      EMRALD=VOCAB(-31350140286 ,1)
      PYRAM=VOCAB(-25393806950 ,1)
      PEARL=VOCAB(-25478245736 ,1)
      RUG=VOCAB(-24337211328 ,1)
      CHAIN=VOCAB(-32444986980 ,1)
      SPICES=VOCAB(-23821237366 ,1)
      CROWN=VOCAB(-32402581604 ,1)
      RING=VOCAB(-24387303616 ,1)
      SWORD=VOCAB(-23791676792 ,1)
      MITHRL=VOCAB(-27071461212 ,1)
      SCHOL=VOCAB(-23875793000 ,1)
      BACK=VOCAB(-33011152064 ,0)
      LOOK=VOCAB(-27583329472 ,0)
      CAVE=VOCAB(-32473660096 ,0)
      NULL=VOCAB(-26484519872 ,0)
      ENTRNC=VOCAB(-31345454462 ,0)
      DPRSSN=VOCAB(-31920205174 ,0)
      SAY=VOCAB(-23883636672 ,2)
      LOCK=VOCAB(-27583722688 ,2)
      THROW=VOCAB(-23317622866 ,2)
      FIND=VOCAB(-30829755328 ,2)
      INVENT=VOCAB(-29197908580 ,2)
      WEAR=VOCAB(-21720149440 ,2)
      REMOVE=VOCAB(-24404111444 ,2)
...
C
C  CAN-23485594238 S CLOSING (EXCEPT BY MAIN OFFICE).
C
...
C  DWARVES CAN-23485561462 T FOLLOW HIM INTO DEAD
C  END IN MAZE, BUT C-31324495720 LL WAIT FOR HIM OUTSIDE THE DEAD END.
C
...
C  THEY DON-23485922938 S NO ALTERNATIVE.  IF THEY DON'T HAVE TO
...
C
C  THE PIRATE-24022232930 VE FOUND CHEST.
...
6035  CONTINUE
C
C  NOW WE KNOW WHAT-24022597216 S TELL THE POOR SUCKER ABOUT IT.
C
...
C  THE PROP TO -1-PROP.  THIS WAY OBJECTS WON-23485921984 VE
...
C         IF (WD1.EQ.CODE(-27105441472 ,-32613851072 ).AND.WD2.EQ.CODE(-27046820544 )) CALL MAINT
C         IF (DEMO.OR.WD1.NE.CODE(-24403913664 ,-26171400128 ).OR.WD1X.NE.CODE(-24405598144 ))
      IF (WD1.EQ.-27105441402 .AND.WD2.EQ.-27046820544 ) CALL MAINT
      IF (DEMO.OR.WD1.NE.-24403913570 .OR.WD1X.NE.-24405598144 )
     1   GOTO 2615
              CALL LOAD (-24403913664 )
              TURNS2 = TURNS
              TURNS3 = TURNS/10
...
C      IF(WD1.EQ.CODE(-31345457856 ,-24560787392 ).AND.(WD2.EQ.
C     1   CODE(-23804164800 ,-33687592896 ).OR.WD2.EQ.CODE(-21736307392 ,-24560787392 )))
C     2        GOTO 2010
C      IF(WD1.EQ.CODE(-31345457856 ,-24560787392 ).AND.WD2.NE.0)GOTO 2800
C      IF((WD1.NE.CODE(-21736307392 ,-24560787392 ).AND.WD1.NE.CODE(-25997991872 ))
C     1        .OR.(WD2.NE.CODE(-25448886720 ,-23487045568 ).AND.WD2.NE.CODE(-31878294976 )))
C     2        GOTO 2610
C      IF(AT(VOCAB(WD2,1)))WD2=CODE(-25435647424 )
C2610  IF(WD1.NE.CODE(-21719559104 ))GOTO 2630
      IF(WD1.EQ.-31345457756 .AND.(WD2.EQ.-23804164734 .OR.WD2.EQ.-21736307292 ))
     1     GOTO 2010
      IF(WD1.EQ.-31345457756 .AND.WD2.NE.0)GOTO 2800
      IF((WD1.NE.-21736307292 .AND.WD1.NE.-25997991872 )   .OR.
     1   (WD2.NE.-25448886616 .AND.WD2.NE.-31878294976 )) GOTO 2610
...
C  UNLESS VERB IS -23883636672 , WHICH SNARFS ARBITRARY SECOND WORD.
C
4000  VERB=K
      SPK=ACTSPK(VERB)
...
C  YET, AND SO ON.  OBJECT MUST BE HERE UNLESS VERB IS -30829755328  OR -29197908580 
...
5190  IF((VERB.EQ.FIND.OR.VERB.EQ.INVENT).AND.WD2.EQ.0)GOTO 5010
      CALL A5TOA1(WD1,WD1X,-29772659364 ,TK,K)
...
C  DWARVES WON-23485234788 T FOLLOW THE
...
25    K=MOD(IABS(TRAVEL(KK)),1000)
      ...
      GOTO 9
C
C  LOOK.  CAN-23485757012 T DARK (THOUGH IT MAY "NOW"
...
90    CALL RSPEAK(23)
      OLDLC2=LOC
C
C  OKAY, HE-24022727294 S GET ON WITH IT.
C
...
C
8000  CALL A5TOA1(WD1,WD1X,-21707565954 ,TK,K)
...
C  MAYBE BREAK SWORD IF USING THAT AGAINST DWARVES.
      ...
      SPK = 48
      IF (RAN10(5).NE.0.OR.SAVED.NE.-1) GOTO 9126
      DSEEN(I) = .FALSE.
      DLOC(I) = 0
      DKILL = DKILL + 1
      SPK = 47
...
C  AND MOVE HIM THERE, TOO.  THEN DO A NULL MOTION TO GET NEW DESCRIPTION.
      ...
      OBJ=0
      CALL GETIN(WD1,WD1X,WD2,WD2X)
C      IF(WD1.NE.CODE(-20802691008 ).AND.WD1.NE.CODE(-20645830592 ))GOTO 2608
...
9172  SPK=48
      CALL DROP (OBJ,LOC)
      IF (RAN10(4).NE.0.OR.OBJ.NE.DAGGER) GOTO 9173
      SPK = 231
      CALL DSTROY(DAGGER)
      GOTO 9175
9173  CONTINUE
C  IF SAVED NOT = -1, HE BYPASSED THE "START" CALL.
      IF(RAN10(3).EQ.0.OR.SAVED.NE.-1)GOTO 9175
      DSEEN(I)=.FALSE.
      DLOC(I)=0
      SPK=47
      DKILL=DKILL+1
...
C  HAVE BEEN DESTROYED AND NEEDN-23485921984 PLACE'),
